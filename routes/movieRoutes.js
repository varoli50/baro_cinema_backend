...
const {addMovie,delMovie, getAllMovie,uploadMovieImg} = require('../controllers/movieController.js')

const router = express.Router()

router.post('/movieimage/:movieID',upload.single('image'),uploadMovieImg)
